...
static struct nocerr_info_type nocerr_cfgdata[] = {
	/* [0] AGGRE1_NOC */
	{
		...
		.syndrome      = {
			...
			.sfty_ctl = (struct nocerr_sfty_ctl_syndrome []){ {0} },
		},
		.num_sfty_ctl  = 1U,
		.sfty_ctl_hw   = (struct noc_sfty_ctl_hw *[]){ &QNOC_SFTY_CTL_1_0 },
		.sfty_ctl_addrs = (void *[]){
			(void *)A1NOC_SFTY_CTL_BASE,
		},
		.num_sfty_aggs = (uint32_t []){ 0U },
		.sfty_aggs     = NULL,
	},
	/* [1] AGGRE2_NOC */
	{
		...
		.sfty_ctl_hw   = (struct noc_sfty_ctl_hw *[]){ &QNOC_SFTY_CTL_1_0 },
		.sfty_ctl_addrs = (void *[]){
			(void *)A1NOC_SFTY_CTL_BASE, /* A2NOC feeds A1NOC ctl */
		},
		.num_sfty_aggs = (uint32_t []){ 0U },
		.sfty_aggs     = NULL,
	},
	/* [2] PCIE_ANOC */
	{
		...
		.num_sfty_ctl  = 1U,
		.sfty_ctl_hw   = (struct noc_sfty_ctl_hw *[]){ &QNOC_SFTY_CTL_1_0_L },
		.sfty_ctl_addrs = (void *[]){
			(void *)PCIE_ANOC_SFTY_CTL_BASE,
		},
		.num_sfty_aggs = (uint32_t []){ 0U },
		.sfty_aggs     = NULL,
	},
	...
	/* [4] CONFIG_NOC */
	{
		...
		.num_sfty_ctl  = 1U,
		.sfty_ctl_hw   = (struct noc_sfty_ctl_hw *[]){ &QNOC_SFTY_CTL_1_0_B },
		.sfty_ctl_addrs = (void *[]){
			(void *)CNOC_SFTY_CTL_BASE,
		},
		.num_sfty_aggs = (uint32_t []){ 0U },
		.sfty_aggs     = NULL,
	},
